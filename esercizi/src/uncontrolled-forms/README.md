Create an uncontrolled component called UncontrolledLogin, containing three inputs: a username input, a password input and a remember checkbox. Add a "login" button to the Login component
